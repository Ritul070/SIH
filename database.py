...
data = [
    ("Gujarat", "Anand", "Anand", 2024, 0.62, 0.55, 0.29, 52.7, "Safe"),

    ("Gujarat", "Kheda", "Nadiad", 2024, 0.74, 0.66, 0.48, 72.7, "Semi-Critical"),

    ("Gujarat", "Mehsana", "Mehsana", 2024, 0.81, 0.73, 0.76, 104.1, "Over-Exploited"),

    ("Gujarat", "Ahmedabad", "Daskroi", 2024, 0.91, 0.82, 0.68, 82.9, "Critical"),

    ("Gujarat", "Vadodara", "Savli", 2024, 0.76, 0.69, 0.41, 59.4, "Safe"),

    ("Rajasthan", "Jaipur", "Sanganer", 2024, 0.51, 0.46, 0.43, 93.5, "Critical"),

    ("Rajasthan", "Jodhpur", "Luni", 2024, 0.42, 0.38, 0.41, 107.9, "Over-Exploited"),

    ("Madhya Pradesh", "Indore", "Depalpur", 2024, 0.69, 0.63, 0.34, 54.0, "Safe")
]
...
print("INGRES database created successfully!")